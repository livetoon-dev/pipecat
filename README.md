...
## 🎌 Livetoon TTS Integration

**This fork includes Livetoon TTS support** - High-quality Japanese speech synthesis.
...
```python
from pipecat.services.livetoon import LivetoonTTSService
...
async for frame in tts_service.run_tts("こんにちは、Livetoonです"):
    # Handle audio frames
    pass
```
