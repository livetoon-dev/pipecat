...
### 🇯🇵 LiveToon Services (Japanese Speech)

This fork includes **LiveToon TTS and STT services** for high-quality Japanese speech processing:

- **LiveToon TTS**: High-quality Japanese text-to-speech synthesis with voice customization
- **LiveToon STT**: Accurate Japanese speech recognition with VAD-based dynamic buffering
